...
<div
    ...
    x-show="show"
    x-transition.opacity.duration.300ms
    class="mb-6 flex items-start justify-between rounded-2xl border border-rose-200 bg-rose-50 px-5 py-4 shadow-sm">
    ...
    <ul class="mt-4 space-y-2 text-sm text-amber-800">
        ...
        @foreach($errors->all() as $error)
            ...
            <li class="flex items-start gap-2">
                ...
                <span
                    class="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500">
                </span>
